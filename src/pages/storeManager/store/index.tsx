  ...
  return (
    <PageContainer>
      ...
      {addModalVisible ? (
        ...
        >
          <div style={{ display: 'flex' }}>
            <img
              src="https://bootx-pdd.oss-cn-hangzhou.aliyuncs.com/%E9%85%8D%E5%9B%BE.png"
              width={130}
            />
            <Card
              title={<h3 style={{ fontWeight: 600 }}>店铺绑定</h3>}
              bordered={false}
              size="small"
            >
              <p>
                1.新绑定的店铺需要先购买应用{' '}
                <a style={{ marginLeft: 16 }}>我要去拼多多服务市场&gt;&gt;</a>
              </p>
              <p style={{ display: 'flex' }}>
                2.在拼多多服务市场购买成功后，回到本页面点击授权即可
                <Button
                  style={{ marginLeft: 16 }}
                  type="primary"
                  onClick={() => {
      ...
      {bindStoreModalVisible ? (
        <Modal visible={bindStoreModalVisible} footer={null} closable={false} width={700}>
